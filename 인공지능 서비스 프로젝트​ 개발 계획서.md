...
gantt
    ...
    title 인공지능 서비스 프로젝트 일정

    section 스프린트
    Sprint 1 :crit, sprt1, 2025-03-20, 1w
    Sprint 2 :crit, sprt2, after sprt1, 1w
    Sprint 3 :crit, sprt3, after sprt2, 1w
    Sprint 4 :crit, sprt4, 2025-05-08, 1w
    Sprint 5 :crit, sprt5, after sprt4, 1w
    Sprint 6 :crit, sprt6, after sprt5, 1w
    Sprint 7 :crit, sprt7, after sprt6, 1w
    Sprint 8 :crit, sprt8, after sprt7, 1w

    section 작업 내역
    주제 선정 :task1, 2025-03-20, 2d
    시장 분석 :task2, after task1, 2d
    사용 기술 및 개발 도구 선정 :task3, after task2, 2d
    개발 계획서 작성 :task4, after task3, 1d
    개발 계획 발표 :milestone, 2025-03-27, 0d
    환경 구축: task5, after task4, 1d
    데이터 수집: task6, after task5, 2d
    긍정/부정 비율 기능 구현: task7, after task6, 2d
    리뷰 필터링 기능 구현: task8, after task7, 2d
    데모 시연 :milestone, 2025-04-17, 0d
    로그인 기능 구현: task9, after task8, 2d
    북마크 기능 구현: task10, after task9, 2d
