...
quadrantChart
    x-axis "리뷰 외 지표 없음(주관성 비보호)" --> "리뷰 외 지표 있음(주관성 보호)"
    y-axis "AI 비활용" --> "AI 활용"
...
flowchart TD
    ...
    subgraph mainPage[메인 페이지]
        ...
        isSignedIn{로그인이 되어 있는가?}
        isSignedIn -- N --> login[로그인]
        isSignedIn -- Y --> profile[프로필]
        login --> profile
    end
...
gantt
    ...
    section Sprint
    Sprint 1 :crit, des1, 2025-03-20, 7d
    Sprint 2 :crit, des2, after des1, 7d
    Sprint 3 :crit, des3, after des2, 7d
    Sprint 4 :crit, des4, 2025-05-08, 7d
    Sprint 5 :crit, des5, after des4, 7d
    Sprint 6 :crit, des6, after des5, 7d
    Sprint 7 :crit, des7, after des6, 7d
    Sprint 8 :crit, des8, after des7, 7d

    section Critical tasks
    주제 선정 :des9, 2025-03-20, 2d
    시장 분석 :after des9, 2d
    Create tests for renderer           :2d
    개발 계획 발표                 :milestone, isadded, 2025-03-27, 0d
    데모 시연                 :milestone, isadded, 2025-04-17, 0d
    최종 시연                 :milestone, isadded, 2025-06-05, 0d
